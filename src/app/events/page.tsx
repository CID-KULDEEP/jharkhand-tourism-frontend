  ...
  return (
    <main className="min-h-screen">
      ...
      <header className="sticky top-0 z-40 w-full border-b bg-background/80 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3">
          ...
          <nav className="hidden items-center gap-6 md:flex">
            ...
            <Link href="/events#highlights" className="text-sm hover:underline">Highlights</Link>
          </nav>
      ...
      <section className="mx-auto max-w-7xl px-4 py-8">
        ...
        <p className="mt-2 text-sm text-muted-foreground">Discover upcoming cultural programs, fairs, and local gatherings.</p>

        <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {[1,2,3,4,5,6].map((i) => (
            <div key={i} className="rounded-lg border p-4">
              <div className="aspect-video w-full overflow-hidden rounded bg-muted" />
              <div className="mt-3 font-medium">Event {i}</div>
